...
% Putting the following figure inside dot_product.tex, where it belongs, causes an error. I think
% This is because it's then an M4 include nested inside another include.
m4_ifelse(__me,1,[:
<% marg(130) %>
<%
  fig(
    'eg-zero-work-around-closed-path',
    %q{Example \ref{eg:zero-work-around-closed-path}.},
    {'anonymous'=>true}
  )
%>
<% end_marg %>
...
<% begin_sec("Varying force",m4_ifelse(__me,1,4,0)) %>\index{work!done by a varying force}
