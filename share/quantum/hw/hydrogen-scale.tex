...
% This one gets used in SN and Mod, has ref to subsec:hydrogen-energies.
%%%%%
(a) A distance scale is shown below the
m4_ifelse(__mod,1,[:wavefunction:],[:wavefunctions and probability densities:])
illustrated in figure
m4_ifelse(__mod,1,[:\figref{hydrogen-ground-state-with-scale} on page \pageref{fig:hydrogen-ground-state-with-scale}:],[:\figref{hydrogen-three-states} on page \pageref{fig:hydrogen-three-states}:]).
