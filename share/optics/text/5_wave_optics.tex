...
half wavelengths, so it is at a negative extreme. There is
...
therefore to a more closely spaced set of diffraction fringes,
as shown in figure \figref{double-slit-wavelength}.
\end{eg}
