...
<% end_marg %>
        ...
        a $\zu{He}^{++}$ ion as the nucleus of a He atom.\index{Rutherford!characterization of alpha particles}
...
%>
        ...
        rare to explain what was actually observed.\index{Rutherford!discovery of nucleus}
...
%>
  ...
  <% begin_sec("The weak nuclear force; beta decay",m4_ifelse(__lm,1,[:4:],[:nil:]),'weak-force') %>\index{weak nuclear force}
...
<% begin_sec("Fusion",nil,'fusion') %>
 ...
 %%----------------------------------------------
<% end_sec('fusion') %>
<% begin_sec("Nuclear energy and binding energies",m4_ifelse(__mod,1,nil,4),'nuclearenergy') %>
